...
class SalesQuotationLines(BaseContent):
    ...
    shipping = models.ForeignKey('system.Choice', on_delete = models.SET_NULL, null= True, blank = True, related_name='quotation_method')
    date = models.DateTimeField(null=True,blank=True)
    bundle = models.CharField(max_length=255, null=True, blank=True)
