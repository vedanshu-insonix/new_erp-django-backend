...
class Translation(BaseContent):
    ...
    table = models.ForeignKey('DataTable', on_delete = models.SET_NULL, null = True, blank = True, related_name='%(class)s_translation')
    table_record = models.IntegerField(null=True, blank = True)
    selector = models.ForeignKey('system.Selectors', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    containerType = models.ForeignKey('warehouse.ContainerTypes', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    column = models.ForeignKey('Column', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    menu = models.ForeignKey('Menu', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    choice = models.ForeignKey('Choice', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    help = models.ForeignKey('Help', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    button = models.ForeignKey('Button', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    data = models.ForeignKey('Data', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    dataset = models.ForeignKey('DataTable', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    stage = models.ForeignKey('Stage', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    tag = models.ForeignKey('Tag', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    tile = models.ForeignKey('Tile', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    list = models.ForeignKey('List', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    form = models.ForeignKey('Form', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    stage_action = models.ForeignKey('StageAction', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    formsection = models.ForeignKey('FormSection', on_delete = models.SET_NULL, null=True, blank=True, related_name='translation')
    configuration = models.ForeignKey('Configuration', on_delete = models.SET_NULL, null = True, blank=True, related_name='translation')
    formdata = models.ForeignKey('FormData', on_delete = models.CASCADE, null = True, blank=True, related_name='translation')
