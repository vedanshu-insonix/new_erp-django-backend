...
router.register(r'orderlines', orders_views.SalesOrderLinesViewSet)
...
router.register(r'returnlines', return_views.SalesReturnLinesViewSet)
...
router.register(r'journaltemplates', general_views.JournalTemplateViewSet)
